 ...
 * https://github.com/korhner/asciimg/blob
 * /95c7764a6abe0e893fae56b3b6b580e09e1de209/src/main/java/io/korhner
...
public class CharConverter {
    ...
    /**
     * Renders a given character, according to how it looks in the font
     * specified in the
    ...
    public static boolean[][] convertToBoolArray(char c) {
        BufferedImage img = getBufferedImage(c, FONT_NAME,
                DEFAULT_PIXEL_RESOLUTION);
        boolean[][] matrix =
                new boolean[DEFAULT_PIXEL_RESOLUTION][DEFAULT_PIXEL_RESOLUTION];
    ...
    private static BufferedImage getBufferedImage(char c, String fontName,
                                                  int pixelsPerRow) {
        String charStr = Character.toString(c);
        Font font = new Font(fontName, Font.PLAIN, pixelsPerRow);
        BufferedImage img = new BufferedImage(pixelsPerRow, pixelsPerRow,
