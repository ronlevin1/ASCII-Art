...
public class InvalidResolutionException extends AsciiArtException {
    ...
    /**
     * Constructs a new InvalidResolutionException with a message based on the provided flag.
     *
    ...
    /**
     * Constructs a new InvalidResolutionException with the specified detail message.
     *
